...
export const ThemeProvider = ({ children, ...rest }) => {
    ...
    return <ContextProvider.Provider value={merged}>{children}</ContextProvider.Provider>
}


export type ContextDefaults = Record<string, string>;

export const useStyledClass = (baseClass: string, keys: string[], defaults: ContextDefaults) => {
