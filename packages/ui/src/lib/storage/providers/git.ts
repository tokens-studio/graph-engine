...
export abstract class GitStorage extends RemoteStorage<GitStorageSaveOptions, GitStorageSaveOption> {
    ...
    public async write(files: RemoteStorageFile[], saveOptions: GitStorageSaveOption): Promise<boolean> {
