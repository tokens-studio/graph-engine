...
import { providersSelector, storageProviderSelector } from '@/redux/selectors/storage.ts';
                ...
                return (
                    <Box key={provider.name}>
                        <Stack
                            ...
                            css={{ padding: '$3', border: '1px solid $border', borderRadius: '$2' }}
                        >
...
export function CreateEditGithubStorage({ storage }: CreateEditGithubStorageProps) {
    ...
    return (
        ...
        >
            ...
            <TextInput
                ...
                name="secret"
                required
                trailingAction={<IconButton variant='invisible' icon={<Icon />} onClick={toggleMasked} />}
            />
