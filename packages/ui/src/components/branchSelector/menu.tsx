...
export const BranchSwitchMenuContent = styled(
  BranchSwitchMenuPrimitive.Content,
  {
    minWidth: 180,
...
const StyledBranchSwitchMenuCheckboxItem = styled(
  BranchSwitchMenuPrimitive.CheckboxItem,
  itemStyles,
);
const StyledBranchSwitchMenuItem = styled(BranchSwitchMenuPrimitive.Item, {
  ...itemStyles,
  paddingLeft: '$6',
});

const StyledBranchSwitchMenuItemIndicator = styled(
  BranchSwitchMenuPrimitive.ItemIndicator,
  {},
);

const StyledBranchSwitchMenuSeparator = styled(
  BranchSwitchMenuPrimitive.Separator,
  {
    height: '1px',
...
const StyledBranchSwitchMenuMainTrigger = styled(
  BranchSwitchMenuPrimitive.Trigger,
  {
    display: 'flex',
    alignItems: 'center',
    fontSize: '$xsmall',
...
const StyledBranchSwitchMenuTrigger = styled(
  BranchSwitchMenuPrimitive.Trigger,
  {
    display: 'flex',
    alignItems: 'center',
...
const StyledBranchSwitchSubmenu = styled(
  BranchSwitchMenuPrimitive.DropdownMenuGroup,
  {
    position: 'absolute',
    left: '$2',
  },
...
const StyledBranchSwitchMenuRadioGroup = styled(
  BranchSwitchMenuPrimitive.RadioGroup,
  {},
);

const StyledBranchSwitchMenuRadioItem = styled(
  BranchSwitchMenuPrimitive.RadioItem,
  itemStyles,
);

const StyledBranchSwitchMenuArrow = styled(BranchSwitchMenuPrimitive.Arrow, {
...
export const BranchSwitchMenuItemIndicator =
  StyledBranchSwitchMenuItemIndicator;
