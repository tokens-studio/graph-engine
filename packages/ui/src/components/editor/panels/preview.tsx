...
export const Preview = () => {
	...
	return (
		<Stack
			...
			gap={2}
			style={{
				padding: 'var(--component-spacing-md) var(--component-spacing-md)'
			}}
		>
			...
			<Stack direction='row' gap={3} wrap>
				<Link href={`/preview?id=${previewId}&template=react`} target='_blank'>
					<Button icon={<ImageIcon src={ReactIcon.src} />}>React</Button>
				</Link>
				<Link
					href={`/preview?id=${previewId}&template=angular`}
					target='_blank'
				>
					<Button icon={<ImageIcon src={Angular.src} />}>Angular</Button>
				</Link>
				<Link href={`/preview?id=${previewId}&template=vue`} target='_blank'>
					<Button icon={<ImageIcon src={VueIcon.src} />}>Vue</Button>
				</Link>
				<Link href={`/preview?id=${previewId}&template=svelte`} target='_blank'>
					<Button icon={<ImageIcon src={SvelteIcon.src} />}>Svelte</Button>
				</Link>
				<Link href={`/preview?id=${previewId}&template=solid`} target='_blank'>
					<Button icon={<ImageIcon src={SolidIcon.src} />}>Solid</Button>
				</Link>
				<Link
					href={`/preview?id=${previewId}&template=vanilla`}
					target='_blank'
				>
					<Button icon={<ImageIcon src={VanillaIcon.src} />}>Vanilla JS</Button>
				</Link>
			</Stack>
			<Text>Keep this panel open for previews to work</Text>
