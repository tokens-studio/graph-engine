import { ArraySchema, NumberSchema } from '../../schemas/index.js';
...
export default class NodeDefinition extends Node {
    ...
    static description = 'Generates a sequence that alternates between positive and negative values based on a pattern';
