...
export default class NodeDefinition extends Node {
	...
	static description =
		'Blends two colors together based on a specified modifier. The output is a hex color string. The modifier can be used to lighten, darken, saturate, desaturate, or mix the two colors together.';
