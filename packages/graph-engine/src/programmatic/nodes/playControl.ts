...
export interface IPlayControlNode<
	T extends Node & IPlayControlNode<T> = PlayControlNode
> {
	playControls: PlayControls<T>;
}

export class PlayControlNode
	extends Node
	implements IPlayControlNode<PlayControlNode>
{
	playControls: PlayControls<PlayControlNode> =
		new PlayControls<PlayControlNode>(this);
