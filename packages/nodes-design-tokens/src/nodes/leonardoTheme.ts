...
import { ColorSchema, INodeDefinition, Node, NumberSchema, StringSchema } from "@tokens-studio/graph-engine";
...
export default class LeonardoThemeNode extends Node {
    ...
    execute(): void | Promise<void> {
        ...
        const { backgroundColor, colors, contrast, saturation, lightness } = this.getAllInputs();
