...
const meta = {
    ...
    tags: ['autodocs'],
    render: (args) => html`<theme-context .values=${args}><tok-button>asd</tok-button><theme-context>`,
    argTypes: {
        theme: {
...
export const Primary: Story = {
    render: (args) => {
        return html`<theme-context .values=${args}><tok-button>Single Context</tok-button></theme-context>`
    }
};
